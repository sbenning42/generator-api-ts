...
export class StoreUtils {
    ...
    updateById(
        ...
        return populateAll(
            this.Store.findByIdAndUpdate(id, body, options, cb),
            populates
        ) as StoreDocumentQuery;
    }
    ...
    updateOne(
        ...
        return populateAll(
            this.Store.findOneAndUpdate(condition, body, options, cb),
            populates
        ) as StoreDocumentQuery;
    }
    ...
    updateMany(
        ...
        return populateAll(
            this.Store.updateMany(condition, body, options, cb),
            populates
        );
    }
...
export class StoreRouter {
    ...
    private setupRouter() {
        ...
        this.router
            .get('/', jwtMiddleware, mainStoreControllers.getAll)
            .post('/', jwtMiddleware, mainStoreControllers.create)
            .get('/:id', jwtMiddleware, mainStoreControllers.getById)
            .delete('/:id', jwtMiddleware, mainStoreControllers.delete);
    }
