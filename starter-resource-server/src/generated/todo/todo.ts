...
export class TodoUtils {
    ...
    sanitizeCreateBody(body: TodoCreateBody) {
        ...
        return ['_id', 'title', 'done', 'json'].reduce<TodoCreateBody>((sanitizedBody, key) => body[key] !== undefined
            ? {
                ...sanitizedBody,
                [key]: body[key]
            }
...
export class TodoRouter {
    ...
    private setupRouter() {
        ...
        this.router
            .get('/', jwt, mainTodoControllers.getAll)
            .post('/', jwt, todoOwner, mainTodoControllers.create)
            .get('/:id', jwt, mainTodoControllers.getById)
            .put('/:id', jwt, todoOwner, mainTodoControllers.update)
            .delete('/:id', jwt, todoOwner, mainTodoControllers.delete)
